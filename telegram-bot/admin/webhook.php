...
if ($action == 'on') {
    $url = "https://huaer.shop/telegram-bot/bot/hook.php";   // 请确认你的域名正确
...
<div class="max-w-2xl mx-auto bg-white rounded-3xl shadow-xl p-10">
    ...
    <div class="mt-12 text-center text-gray-500">
        <p>Webhook URL: <code class="bg-gray-100 px-3 py-1 rounded">https://huaer.shop/telegram-bot/bot/hook.php</code></p>
    </div>
