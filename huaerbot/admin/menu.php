...
<div class="max-w-7xl mx-auto p-6">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex gap-3">
            <a href="menu.php" 
               class="flex items-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl font-medium shadow-sm">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-3xl shadow p-8 sticky top-20">
