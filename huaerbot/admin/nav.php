        ...
        <div class="flex items-center justify-between h-14">
            ...
            <div class="flex items-center gap-1 overflow-x-auto text-sm">
                ...
                <a href="broadcast.php"
                   class="px-3 py-2 rounded-lg whitespace-nowrap <?= in_array($current, ['broadcast.php', 'broadcast_progress.php']) ? 'bg-indigo-600 text-white' : 'text-gray-600 hover:bg-gray-100' ?>">
                    <i class="fas fa-paper-plane mr-1"></i>群发
                </a>
                <a href="broadcast_history.php"
                   class="px-3 py-2 rounded-lg whitespace-nowrap <?= $current === 'broadcast_history.php' ? 'bg-indigo-600 text-white' : 'text-gray-600 hover:bg-gray-100' ?>">
