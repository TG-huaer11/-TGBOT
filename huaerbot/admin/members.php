...
<div class="max-w-7xl mx-auto p-6">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex gap-3">
            ...
            <a href="dashboard.php" class="flex items-center gap-2 px-5 py-2.5 bg-white rounded-2xl shadow-sm hover:shadow text-indigo-600 hover:text-indigo-700 transition">
