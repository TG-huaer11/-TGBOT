...
//            $parent_where['top_parent'] = $this->auth->user_id;
        ...
        foreach ($yes_user_recharges as $key => $v) {
            ...
            $yes_user_recharge = bcadd($yes_user_recharge, $v['num'], 2);
        }
        ...
        foreach ($mon_user_recharges as $key => $v) {
            $mon_user_recharge = bcadd($mon_user_recharge, $v['num'], 2);
        }
        ...
        foreach ($monyes_user_recharges as $key => $v) {
            $monyes_user_recharge = bcadd($monyes_user_recharge, $v['num'], 2);
        }
