<?php /*a:4:{s:58:"/www/wwwroot/tiktokv.fit/app/admin/view/deposit/index.html";i:1741911572;s:59:"/www/wwwroot/tiktokv.fit/app/admin/view/layout/default.html";i:1716492206;s:56:"/www/wwwroot/tiktokv.fit/app/admin/view/common/meta.html";i:1716492208;s:58:"/www/wwwroot/tiktokv.fit/app/admin/view/common/script.html";i:1716492208;}*/ ?>
<!DOCTYPE html>
    ...
    <?php if($admin['id']==1): ?>
        ...
        <button type="submit" style="padding: 10px 30px;">搜索</button>
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover table-nowrap"
                           data-operate-edit="<?php echo $auth->check('deposit/edit'); ?>"
                           width="100%">
                    </table>
                </div>
            </div>
