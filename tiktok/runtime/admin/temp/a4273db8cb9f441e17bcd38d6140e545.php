<?php /*a:4:{s:55:"/www/wwwroot/tiktokv.fit/app/admin/view/txtz/index.html";i:1733155648;s:59:"/www/wwwroot/tiktokv.fit/app/admin/view/layout/default.html";i:1716492206;s:56:"/www/wwwroot/tiktokv.fit/app/admin/view/common/meta.html";i:1716492208;s:58:"/www/wwwroot/tiktokv.fit/app/admin/view/common/script.html";i:1716492208;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover table-nowrap"
                           data-operate-edit="<?php echo $auth->check('kd/edit'); ?>"
                           data-operate-del="<?php echo $auth->check('kd/del'); ?>"
                           width="100%">
                    </table>
                </div>
            </div>
