<?php /*a:4:{s:66:"/www/wwwroot/tiktokv.fit/app/admin/view/general/profile/index.html";i:1740925734;s:59:"/www/wwwroot/tiktokv.fit/app/admin/view/layout/default.html";i:1716492206;s:56:"/www/wwwroot/tiktokv.fit/app/admin/view/common/meta.html";i:1716492208;s:58:"/www/wwwroot/tiktokv.fit/app/admin/view/common/script.html";i:1716492208;}*/ ?>
<!DOCTYPE html>
                ...
                <form id="update-form" role="form" data-toggle="validator" method="POST" action="<?php echo url('general.profile/update'); ?>">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label for="goole" class="control-label"><?php echo __('扫码绑定谷歌登录验证'); ?>:</label>
                            <img src="<?php echo htmlentities($qrCodeUrl); ?>" width="200"/>
                        </div>
                        <div class="form-group">
                            <label for="goole" class="control-label">是否绑定谷歌</label>
                            <input type="radio"
                            <?php if($admin['confirm']=='1'): ?>checked<?php endif; ?>
                            name="row[confirm]" value="1" />是
                            <input type="radio"
                            name="row[confirm]"
                            <?php if($admin['confirm']=='2'): ?>checked<?php endif; ?> 
                            value="2" />否
                        </div>
                        <input type="hidden" value="<?php echo htmlentities($secret); ?>" name="row[keyGoogle]" />
                        <div class="form-group">
