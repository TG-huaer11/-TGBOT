<?php /*a:4:{s:60:"/www/wwwroot/tiktokv.fit/app/admin/view/user/user/index.html";i:1741875080;s:59:"/www/wwwroot/tiktokv.fit/app/admin/view/layout/default.html";i:1716492206;s:56:"/www/wwwroot/tiktokv.fit/app/admin/view/common/meta.html";i:1716492208;s:58:"/www/wwwroot/tiktokv.fit/app/admin/view/common/script.html";i:1716492208;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    ...
                    <div id="toolbar" class="toolbar">
                        <?php echo build_toolbar('refresh,add'); if($template == 'default'): ?>
                        <a class="btn btn-danger btn-multi btn-disabled disabled" href="javascript:;"
                           data-params="status=2"><?php echo __('Status 2'); ?></a>

                        <a class="btn btn-success btn-multi btn-disabled disabled" href="javascript:;"
                           data-params="status=1"><?php echo __('Status 1'); ?></a>
                        <a class="btn btn-success btn-money btn-disabled disabled" href="javascript:;" data-value="add">
                            <?php echo __('Money'); ?></a>
                        <a class="btn btn-danger btn-money btn-disabled disabled" href="javascript:;" data-value="sub">
                            <?php echo __('Deduction'); ?></a>
                        <?php endif; ?>
                        <a class="btn btn-success" href="javascript:;" ><?php echo htmlentities($invite_code); ?></a>
                        <a class="btn btn-success copy" href="javascript:;" data-clipboard-action="copy" data-clipboard-text="https://venice-mall.xyz/h5/#/pages/login/register?invite_code=<?php echo htmlentities($invite_code2); ?>" class="copy ">复制链接</a>
                        
                        
                         <!--  <a class="btn btn-danger btn-multi" href="<?php echo url('kd/index'); ?>"
                          >批量卡单</a>-->
