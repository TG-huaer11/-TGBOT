<?php /*a:6:{s:56:"/www/wwwroot/tiktokv.fit/app/admin/view/index/index.html";i:1740915866;s:56:"/www/wwwroot/tiktokv.fit/app/admin/view/common/meta.html";i:1716492208;s:58:"/www/wwwroot/tiktokv.fit/app/admin/view/common/header.html";i:1733324646;s:56:"/www/wwwroot/tiktokv.fit/app/admin/view/common/menu.html";i:1735686326;s:59:"/www/wwwroot/tiktokv.fit/app/admin/view/common/control.html";i:1716492208;s:58:"/www/wwwroot/tiktokv.fit/app/admin/view/common/script.html";i:1716492208;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <body class="hold-transition <?php echo htmlentities((config('fastadmin.adminskin') ?: 'skin-black-blue')); ?> sidebar-mini fixed <?php echo config('fastadmin.multipletab')?'multipletab':''; ?> <?php echo config('fastadmin.multiplenav')?'multiplenav':''; ?>" id="tabs">
    <div id="hhh" class="wrapper">

            <!-- 头部区域 -->
            <header id="header" class="main-header">   
                <?php if(preg_match('/\/yfcmf\/|admin/i', url('index/index'))): ?>
                <div class="hide alert alert-danger-light text-center" style="margin-bottom:0;border:none;">
...
<nav class="navbar navbar-static-top">
    ...
    <div id="firstnav">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <!-- 多语言列表 -->
                <?php if(config('fastadmin.lang_switch_on')): ?>
                <li class="hidden-xs">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="<?php echo url('agent/index/logout'); ?>" class="btn btn-danger"><i class="fa fa-sign-out"></i>
    ...
    <div id="secondnav">
        <ul class="nav nav-tabs nav-addtabs disable-top-badge" role="tablist">
            <?php if($fixedmenu): ?>
            <li role="presentation" id="tab_<?php echo htmlentities($fixedmenu['id']); ?>" class="<?php echo $referermenu?'':'active'; ?>"><a
                    href="#con_<?php echo htmlentities($fixedmenu['id']); ?>" node-id="<?php echo htmlentities($fixedmenu['id']); ?>" aria-controls="<?php echo htmlentities($fixedmenu['id']); ?>" role="tab"
                    data-toggle="tab"><i class="fa fa-dashboard fa-fw"></i> <span><?php echo htmlentities($fixedmenu['title']); ?></span> <span
                    class="pull-right-container"> </span></a></li>
            <?php endif; if($referermenu): ?>
            <li role="presentation" id="tab_<?php echo htmlentities($referermenu['id']); ?>" class="active"><a href="#con_<?php echo htmlentities($referermenu['id']); ?>"
                                                                                 node-id="<?php echo htmlentities($referermenu['id']); ?>"
                                                                                 aria-controls="<?php echo htmlentities($referermenu['id']); ?>"
                                                                                 role="tab" data-toggle="tab"><i
                    class="fa fa-list fa-fw"></i> <span><?php echo htmlentities($referermenu['title']); ?></span> <span
        ...
        <?php echo $menulist; ?>
            ...
            <div class="content-wrapper tab-content tab-addtabs">
                ...
                <div role="tabpanel" class="tab-pane <?php echo $referermenu?'':'active'; ?>" id="con_<?php echo htmlentities($fixedmenu['id']); ?>">
                    <iframe src="<?php echo htmlentities($fixedmenu['url']); ?>?addtabs=1" width="100%" height="100%" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling-x="no" scrolling-y="auto" allowtransparency="yes"></iframe>
                </div>
                <?php endif; if($referermenu): ?>
                <div role="tabpanel" class="tab-pane active" id="con_<?php echo htmlentities($referermenu['id']); ?>">
                    <iframe src="<?php echo htmlentities($referermenu['url']); ?>?addtabs=1" width="100%" height="100%" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling-x="no" scrolling-y="auto" allowtransparency="yes"></iframe>
                </div>
                <?php endif; ?>
            </div>
            ...
            <footer class="main-footer hide">
                ...
                <strong>Copyright &copy; 2019-<?php echo date('Y'); ?> <a href="https://www.iuok.cn">YFCMF-TP6</a>.</strong> All rights reserved.
            </footer>
...
<!-- /.control-sidebar -->
      ...
      <p>点击页面任意位置取消静音并播放音频</p>
    <audio id="myAudio" muted controls>
     ...
     <script>
         ...
         function check(){
            ...
            // 配置请求，设置请求方法为 GET，请求的 URL 为示例 URL
            xhr.open('GET', "<?php echo url('index/order_info'); ?>", true);
